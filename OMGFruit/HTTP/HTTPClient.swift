...
class HTTPClient {
    func doRequest(_ request: URLRequest, completion: ((Data?, HTTPResponseInfo?, OMGError?) -> ())?) {
        ...
        let dataTask = session.dataTask(with: request, completionHandler: { data, response, error in
            ...
            let httpResponse = HTTPResponseInfoImpl(statusCode: httpURLResponse.statusCode)
